System Fix: caelestia-shell Removal Issues
...
- Use Btrfs Snapshots: Since the system uses Btrfs, set up snapper or timeshift with grub-btrfs. If a package update breaks the system in the future, rollback to a working snapshot directly from the GRUB menu without needing a Live ISO USB.
